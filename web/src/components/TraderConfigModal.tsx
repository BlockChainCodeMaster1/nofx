...
export function TraderConfigModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div
        className="bg-darkmoon-surface border border-darkmoon-border rounded-xl shadow-2xl max-w-3xl w-full my-8"
        style={{ maxHeight: 'calc(100vh - 4rem)' }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-darkmoon-border bg-darkmoon-surface sticky top-0 z-10 rounded-t-xl">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-darkmoon-gold to-[#F3CF55] flex items-center justify-center text-black shadow-lg shadow-darkmoon-gold/20">
              {isEditMode ? (
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg text-darkmoon-text-secondary hover:text-darkmoon-text-primary hover:bg-darkmoon-surface-hover transition-colors flex items-center justify-center"
          >
        ...
        >
          {/* Basic Info */}
          <div className="bg-darkmoon-bg border border-darkmoon-border rounded-lg p-5">
            <h3 className="text-lg font-semibold text-darkmoon-text-primary mb-5 flex items-center gap-2">
              🤖 基础配置
            </h3>
            <div className="space-y-4">
              <div>
                <label className="text-sm text-darkmoon-text-secondary block mb-2">
                  交易员名称
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-3 py-2 bg-darkmoon-surface border border-darkmoon-border rounded text-darkmoon-text-primary focus:border-darkmoon-gold focus:outline-none"
          ...
          <div className="bg-darkmoon-bg border border-darkmoon-border rounded-lg p-5">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 rounded text-sm transition-all ${
                        formData.is_cross_margin
                          ? 'bg-darkmoon-gold text-black font-semibold shadow-md'
                          : 'bg-darkmoon-surface text-darkmoon-text-secondary border border-darkmoon-border hover:border-darkmoon-gold/50'
                      }`}
                    >
                      全仓
                    </button>
                ...
                {isEditMode && (
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-darkmoon-text-secondary">
                        初始余额 ($)
                      </label>
                      <button
                        type="button"
                        ...
                        className="px-3 py-1 text-xs bg-darkmoon-gold text-black rounded hover:bg-[#E1A706] transition-colors disabled:bg-darkmoon-border disabled:text-darkmoon-text-muted disabled:cursor-not-allowed"
                      >
                    ...
                    <input
                      ...
                      step="0.01"
                    />
                    <p className="text-xs text-darkmoon-text-muted mt-1">
                ...
                {!isEditMode && (
                  <div>
                    <label className="text-sm text-darkmoon-text-secondary mb-2 block">
                      初始余额
                    </label>
                    <div className="w-full px-3 py-2 bg-darkmoon-surface border border-darkmoon-border rounded text-darkmoon-text-muted flex items-center gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-4 h-4 text-darkmoon-gold"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-darkmoon-gold text-black rounded hover:bg-[#E1A706] transition-colors"
                  >
                ...
                {/* 币种选择器 */}
                {showCoinSelector && (
                  <div className="mt-3 p-3 bg-darkmoon-surface border border-darkmoon-border rounded">
                    <div className="text-xs text-darkmoon-text-muted mb-2">
                      点击选择币种：
                    </div>
                        ...
                        <button
                          ...
                          className={`px-2 py-1 text-xs rounded transition-colors ${
                            selectedCoins.includes(coin)
                              ? 'bg-darkmoon-gold text-black font-semibold'
                              : 'bg-darkmoon-bg text-darkmoon-text-secondary border border-darkmoon-border hover:border-darkmoon-gold'
                          }`}
                        >
                          {coin.replace('USDT', '')}
                        </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 rounded border-darkmoon-border bg-darkmoon-surface text-darkmoon-gold focus:ring-darkmoon-gold"
                />
                <label className="text-sm text-darkmoon-text-secondary">
                  使用 Coin Pool 信号
                </label>
          ...
          <div className="bg-darkmoon-bg border border-darkmoon-border rounded-lg p-5">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {/* 動態描述區域 */}
                <div
                  className="mt-2 p-3 rounded bg-darkmoon-gold/5 border border-darkmoon-gold/15"
                >
                  <div
                    className="text-xs font-semibold mb-1 text-darkmoon-gold"
                  >
                    {(() => {
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 rounded border-darkmoon-border bg-darkmoon-surface text-darkmoon-gold focus:ring-darkmoon-gold"
                />
                <label className="text-sm text-darkmoon-text-secondary">覆盖默认提示词</label>
                <span className="text-xs text-darkmoon-gold inline-flex items-center gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-darkmoon-surface border border-darkmoon-border rounded text-darkmoon-text-primary focus:border-darkmoon-gold focus:outline-none h-24 resize-none"
                  placeholder={
                    formData.override_base_prompt
                      ? '输入完整的交易策略提示词...'
                      : '输入额外的交易策略提示...'
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 p-6 border-t border-darkmoon-border bg-darkmoon-surface sticky bottom-0 z-10 rounded-b-xl">
          <button
            onClick={onClose}
            className="px-6 py-3 bg-darkmoon-bg text-darkmoon-text-secondary rounded-lg hover:bg-darkmoon-surface-hover transition-all duration-200 border border-darkmoon-border"
          >
            取消
          </button>
          {onSave && (
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-darkmoon-gold to-[#F3CF55] text-black rounded-lg hover:shadow-lg transition-all duration-200 disabled:bg-darkmoon-border disabled:cursor-not-allowed font-bold"
            >
